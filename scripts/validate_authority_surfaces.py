...
def validate(agents: str, status: str, readme: str, readme_zh: str, roadmap: str, git_readme: str) -> None:
    ...
    for claim in (
        "future Health Connect", "future HealthKit", "Not yet implemented: Health Connect",
        "Health data | Adapter boundary | Adapter boundary | N/A | Not implemented",
        "Health Connect／reliability 在 Issue #10", "HealthKit／AlarmKit 在 Issue #9",
    ):
        reject(combined, claim, "authority surfaces")
    ...
    require(roadmap, "Historical PRs #2, #15, #16, #20, and #22 are merged history", "roadmap")
...
def read_surfaces(root: Path) -> tuple[str, str, str, str, str, str]:
    return (
        ...
        (root / "docs/git/README.md").read_text(encoding="utf-8"),
    )
