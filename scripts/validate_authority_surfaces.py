...
def self_test() -> None:
    ...
    mutations = [
        ...
        (1,"replace","**Current top Draft evidence:** PR #69\0**Current top Draft evidence:** PR #55","status-current-top"),
        (1,"replace","**This reconciliation packet:** Issue #70\0**This reconciliation packet:** Issue #56","status-current-packet"),
